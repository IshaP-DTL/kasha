...
class userAdmin(admin.ModelAdmin):
    list_display = ['user_id','username','country_code','phone_number','email','password','otp','created_at','updated_at']
admin.site.register(user, userAdmin)
 
class profileAdmin(admin.ModelAdmin):
    list_display = ['profile_id','first_name','last_name','gender','DOB','profile_picture','is_active','is_deleted','user_id']
...
class cartItemsAdmin(admin.ModelAdmin):
    list_display=['cart_item_id','cart_id','product_id','size','price','quantity','color']
admin.site.register(cartItems,cartItemsAdmin)
 
class orderAdmin(admin.ModelAdmin):
    list_display=['order_id','cart_id','user_id','grand_total','status','address_id']
admin.site.register(order,orderAdmin)
 
class orderItemsAdmin(admin.ModelAdmin):
    list_display=['order_item_id','product_id','order_id','quantity','price','size']
admin.site.register(orderItems,orderItemsAdmin)
 
class reviewAdmin(admin.ModelAdmin):
    list_display=['review_id','product_id','order_item_id','user_id','rating','comment']
...
class cardDetailAdmin(admin.ModelAdmin):
    list_display=('card_id','card_holder_name','card_number','card_cvv','card_expiry','card_balance')
...
class deliveryPersonAdmin(admin.ModelAdmin):
    ...
    list_display=('delivery_person_id','password','delivery_person_name','mobile','email','wallet')
...
class orderHistoryAdmin(admin.ModelAdmin):
    list_display = ('order_id','user_id','address_id','delivery_person_id','message','created_at')
